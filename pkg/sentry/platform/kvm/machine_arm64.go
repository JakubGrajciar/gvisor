...
func (c *vCPU) fault(signal int32, info *arch.SignalInfo) (usermem.AccessType, error) {
	...
	*info = arch.SignalInfo{Signo: signal}
	...
	switch ret {
	case _ESR_SEGV_MAPERR_L0:
		fallthrough
	case _ESR_SEGV_MAPERR_L1:
		fallthrough
	...
	case _ESR_SEGV_MAPERR_L3:
		...
		write = true
		execute = false
	case _ESR_SEGV_ACCERR_L1:
		fallthrough
	case _ESR_SEGV_ACCERR_L2:
		fallthrough
	case _ESR_SEGV_ACCERR_L3:
		fallthrough
	case _ESR_SEGV_PEMERR_L1:
		fallthrough
	case _ESR_SEGV_PEMERR_L2:
		fallthrough
	case _ESR_SEGV_PEMERR_L3:
